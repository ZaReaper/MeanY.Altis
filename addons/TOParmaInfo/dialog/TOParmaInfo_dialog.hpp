...
class TOParmaInfoD
{
	...
	{	
		...
		class TAGeneralInfoBackground: RscText
		{
			...
			type = CT_STRUCTURED_TEXT;
			size = 0.030;
			text = "Website: http://www.matureanzacgamers.com Forums: http://www.matureanzacgamers.com TeamSpeak: 108.61.227.20:9357";
			x = "0 * (((safezoneW / safezoneH) min 1.2) / 40)";
