...
//if (_progress > .05) then
///{			
//	["Someone's base locker is being tampered with!!","<t align = 'top' shadow = '1' size = '0.4' color ='#E44646' font='PuristaBold'>%1</t><br />"] spawn BIS_fnc_typeText;
//}; 
