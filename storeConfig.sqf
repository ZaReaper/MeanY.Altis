...
[
	...
	["Empty Storage Crate", "B_supplyCrate_F", 200, "ammocrate"],
	["Fuel Bowser (Working)", "Land_FuelStation_Feed_F", 50000, "object"],
	["ATM", "Land_Atm_01_F", 80000, "object"],
	["Base Locker", "Land_Device_assembled_F", 65000, "object"],
	...
	["Canal Wall (10m Wide)", "Land_Canal_Wall_10m_F", 1000, "object"], // Suggest $1K
...
[
	[ // Main colors
		...
		[
			...
			["Girl Camo", _texDir + "holland.jpg"], //GoT addition (dutch flag)
			["MAG Clan Camo", _texDir + "murica.jpg"],
			["MAG Clan Camo 2", _texDir + "confederate.jpg"],
			["MAG Clan Camo 3", _texDir + "unionjack.jpg"],
...
[
	...
	["LSD", "lsd", localize "STR_WL_ShopDescriptions_LSD", "client\icons\lsd.paa", 20000, 8000],
	["Marijuana", "marijuana", localize "STR_WL_ShopDescriptions_Marijuana", "client\icons\marijuana.paa", 25000, 10000],
	["Cocaine", "cocaine", localize "STR_WL_ShopDescriptions_Cocaine", "client\icons\cocaine.paa", 50000, 20000],
	["Heroin", "heroin", localize "STR_WL_ShopDescriptions_Heroin", "client\icons\heroin.paa", 50000, 25000]
