...
// Spawn settings
A3W_townSpawnCooldown = 4*60;      // Number of seconds to wait between each spawn on a specific town (0 = disabled)
A3W_spawnBeaconCooldown = 4*60;    // Number of seconds to wait between each use of a specific spawn beacon (0 = disabled)
...
A3W_hcObjCachingID = 0;            // ID of the headless client in charge of object caching (1 or 2)
A3W_hcObjSaving = 0;               // Enable headless client vehicle & object saving (0 = no, 1 = yes)
A3W_hcObjSavingID = 0;             // ID of the headless client in charge of object saving (1 or 2)
...
A3W_payrollAmount = 850;           // Amount of money rewarded per territory on each payroll
