...
switch (_boxType) do
{
	...
	case "mission_USSpecial":
	{
		...
		[
			...
			["itm", ["optic_MRCO", "optic_Arco", "optic_Hamr", "optic_SOS","bipod_03_F_oli","optic_KHS_old"], RANDOM_BETWEEN(0,2)],
	...
	case "mission_Main_A3snipers":
	{
		...
		[
			// Item type, Item class(es), # of items, # of magazines per weapon
			["wep", ["srifle_GM6_LRPS_F", "srifle_GM6_camo_LRPS_F","srifle_DMR_05_tan_f","srifle_DMR_06_camo_F"], RANDOM_BETWEEN(1,3), RANDOM_BETWEEN(4,6)],
